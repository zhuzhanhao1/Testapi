...
def send_link():
    url = "https://oapi.dingtalk.com/robot/send?access_token=bfd3a18c4aba39921b6ace3418273b86f9be0fe52d75b61e22fea88609cf00d6"
    xiaoding = DingtalkChatbot(url)
    xiaoding.send_link(title='正在直播中...', text='2万把诸葛...', message_url='https://www.huya.com')

# 老刘老张老王
# eec7d2777756d5cfb66f8f0f3f055946e09923f86796cf3186f6d02d0a66f940
#外面小队
# https://oapi.dingtalk.com/robot/send?access_token=bfd3a18c4aba39921b6ace3418273b86f9be0fe52d75b61e22fea88609cf00d6
...
if __name__ == "__main__":
    # send_ding("测试消息免打扰是否还能收到@的消息","老李")
    send_image()